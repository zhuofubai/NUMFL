...
for(index in 1:length(Dirs)){
  ...
  write(percent_Tarantula, file="Tarantula_SciMark", append=TRUE, ncolumns=n, sep=" ")
  write(percent_Ochiai, file="Ochiai_SciMark", append=TRUE, ncolumns=n, sep=" ")
  write(percent_F1, file="F1_jama_SciMark", append=TRUE, ncolumns=n, sep=" ")
  write(percent_Dstar, file="Dstar_SciMark", append=TRUE, ncolumns=n, sep=" ")
}
