...
k = 5
temp = rep(1, k)
bugid =9##bug1 on line 780

for (i in 1:n) {
	y_raw = read.table("C:/Users/zhuofu/workspace/apacheCommonMath3.1.1/TestDSCompiler/Data11/out.txt")
	y = data.matrix(y_raw[, 2])
    print(i)
    filename = c("C:/Users/zhuofu/workspace/apacheCommonMath3.1.1/TestDSCompiler/Data11/", as.character(i), ".txt")
