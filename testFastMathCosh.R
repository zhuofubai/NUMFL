...
y <- read.table("C:/Users/zhuofu/workspace/apacheCommonMath3.1.1/TestFastMathCosh/Data3/out.txt")
y <- data.matrix(y[, 2])
row<-nrow(y)
y0 <- which(y < 0.5)
y1 <- which(y > 0.5)
...
for (i in 1:n) {
    ...
    print(i)
    filename <- c("C:/Users/zhuofu/workspace/apacheCommonMath3.1.1/TestFastMathCosh/Data3/", as.character(i), ".txt")
