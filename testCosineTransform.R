...
result_bc_c<-result
result_bc_sc<-result
y_raw <- read.table("C:/Users/zhuofu/workspace/apacheCommonMath3.1.1/TestCosineTransformData/Data1/out.txt")
...
for (i in 1:n) {
    ...
    print(i)
    filename <- c("C:/Users/zhuofu/workspace/apacheCommonMath3.1.1/TestCosineTransformData/Data1/", as.character(i), ".txt")
