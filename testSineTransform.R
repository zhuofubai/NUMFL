...
result_bc_c<-result
result_bc_sc<-result
y_raw <- read.table("C:/Users/zhuofu/workspace/apacheCommonMath3.1.1/TestSineTransformData/Data2/out.txt")
...
for (i in 1:n) {
    ...
    print(i)
    filename <- c("C:/Users/zhuofu/workspace/apacheCommonMath3.1.1/TestSineTransformData/Data2/", as.character(i), ".txt")
