...
source('C:/Users/zhuofu/RProject/preprosseData.R')
 source('C:/Users/zhuofu/RProject/buildlinear.R')
 source('C:/Users/zhuofu/RProject/buildPolynominal.R')
n <- 412
result <- rep(0, n)
...
for (i in 1:n) {
  ...
  truth_raw<- read.table("C:/Users/zhuofu/workspace2/apacheCommonMath3.1.1/TestRotationAndVector3D/Data7/truth.txt")
  diff_raw<- read.table("C:/Users/zhuofu/workspace2/apacheCommonMath3.1.1/TestRotationAndVector3D/Data7/diff.txt")
  ...
  if (var(X[, 1])==0||length(y)<30||sum(y)==0||sum(y)==length(y))
{    next }   
##############################################################################
m <- ncol(as.matrix(X))
if (m==1)
